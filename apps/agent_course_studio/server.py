#!/usr/bin/env python3
"""Local server for Agent Course Studio.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Serve Agent Course Studio locally.")
    ...
    print(f"[OK] Agent Course Studio: http://{args.host}:{args.port}")
